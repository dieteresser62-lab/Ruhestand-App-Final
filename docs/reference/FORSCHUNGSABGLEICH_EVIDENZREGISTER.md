...
| Operationaler Gate-Status | Slice 09 begrenzt aktuelle Aussagen auf historische In-sample-Diagnose, technisch getestet oder unter den offengelegten Annahmen beobachtet. Die gesamte eingebettete Historie 1925-2025 und daraus gebildete Rolling Cohorts gelten als explorativ/kontaminiert. `HistoricalBacktestExportV2` manifestiert einen explizit exportierten Lauf mit sauberem Source-Commit und Datenrevision, ist aber kein vollständiges Trial-Log und kein Holdout-Nachweis. FV-G02, FV-G03, FV-G05, FV-G06 und FV-G08 bleiben blockiert; siehe [archiviertes Forschungsprotokoll](../internal/archive/2026-simulator-backtest-hardening/SIMULATOR_BACKTEST_FORSCHUNGSPROTOKOLL.md). |
