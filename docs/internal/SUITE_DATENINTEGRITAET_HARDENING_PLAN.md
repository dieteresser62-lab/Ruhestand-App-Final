...
| 8 | [SLICE_SUITE_DATA_08_SWEEP_HOUSEHOLD_RISK.md](./SLICE_SUITE_DATA_08_SWEEP_HOUSEHOLD_RISK.md) | Partner, Pflege, Langlebigkeit und Tail Risk | P1 | 7 | 7 | nachgebessert - unabhaengiges Re-Review ausstehend |
