...
| 2026-07-14 | Manueller P0-Abnahmefall deckt Geldmarkt-Fehlklassifikation auf; Codex korrigiert innerhalb des bestehenden Scopes | Explizite `money_market`-Kategorie hat Vorrang vor widerspruechlichem `aktien_neu`-Legacy-Typ; Geldmarkt kann nicht mehr als Aktienverkaufsquelle attribuiert werden; Umschichtung Geldmarkt zu Tagesgeld erhoeht die Gesamtliquiditaet nicht. Fokussiert 95/95 + 123/123 + 41/41, Gesamtsuite 3403/3403 ohne offene Handles; fruehere Implementierungsfreigabe ueberholt, erneutes Review und manueller Retest ausstehend. |
