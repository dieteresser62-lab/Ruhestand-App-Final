...
5. **Ergebnisse interpretieren:** Die Monte-Carlo-Kennzahl „Erfolgswahrscheinlichkeit“ ist die modellinterne Erfolgsquote der gewählten Läufe, keine Garantie und keine Aussage des historischen Backtests. Immer gemeinsam mit P10/P50/P90, dem Anteil abgeschlossener Dekumulationsjahre mit mindestens 10 % Kürzung, Portfoliovolatilität, Drawdown, Depoterschöpfung und Pflege-KPIs lesen. Ein Gedankenstrich beim Kürzungsanteil bedeutet, dass kein Lauf einen endlichen Dekumulationsjahres-Nenner lieferte; er ist keine beobachtete 0. Heatmaps zeigen Sensitivitäten, und das Szenario-Log bietet Analysen zu typischen und extremen Verläufen (inkl. Pflegekosten). Für hohe Dynamic-Flex-Entnahmen den detaillierten Logmodus aktivieren und Payout-/VPW-Spalten prüfen.
