...
* **Stress-Pfad-Replay:** Ein ausgewaehltes Monte-Carlo-Szenario kann als vollstaendiger exogener Pfad fixiert und mit der unveraenderten Baseline sowie bis zu drei erlaubten Strategievarianten erneut gerechnet werden. Der Vergleich gilt ausschliesslich fuer diesen einen Pfad und ist weder allgemeines Ranking noch Finanzempfehlung. Pfad, Baseline und Varianten werden lokal als ein aktiver Arbeitsstand gespeichert; ein neuer Pfad ersetzt ihn erst nach Bestaetigung. Versionierter JSON-Export/-Import, Fingerprints, Groessenlimits und Nur-Lesen-Inspektion bei Daten-/Engine-Mismatch schuetzen die Reproduzierbarkeit. Assetallokation, Mindest-Flex, reale Profile und Tranchen sind keine Variantenfelder.
