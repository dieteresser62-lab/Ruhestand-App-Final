...
6. **Experimenteller Vergleich (Sweep/Auto-Optimize):** Im Tab „Sweep“ können die neun sichtbaren Dimensionen automatisiert variiert werden. Fuer jeden sichtbaren Parameter sind kanonische Zuordnung, Consumer und Ergebnisprovenienz geprueft; das ist kein unabhaengiger KPI-Wirkungsnachweis. Nutzen Sie Heatmap und Champion nur zum Erkunden des gewählten Modellraums; beide sind keine fachlich validierte Optimierung oder Empfehlung.
