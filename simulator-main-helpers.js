    ...
    columns.push(
        {
            ...
            valueFormatter: (v, row) => {
                const engineConfig = (typeof window !== 'undefined' ? window.EngineAPI?.CONFIG : null) || (typeof window !== 'undefined' ? window.EngineAPI?.getConfig?.() : null);
                const regimeText = engineConfig?.SCENARIO_TEXT?.[v] || v || '';
