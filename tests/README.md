...
| `stress-replay-contract.test.mjs` | ~380 | Fail-closed Schemas, Variantenbereiche 0–50/0–70, Terminalzeilen und unabhaengige Herkunftsidentitaet |
