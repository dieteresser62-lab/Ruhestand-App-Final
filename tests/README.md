...
| `stress-replay-ui.test.mjs` | ~350 | Controllerweiter Busy-/Reentrancy-Vertrag, Deferred-Promise-Rennen, Reload und Import |
| `stress-replay-renderer.test.mjs` | ~300 | Terminalzeilen, Missingness und eindeutige Jahres-/Prozentpunkt-Deltatexte |
