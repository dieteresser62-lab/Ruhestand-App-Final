...
assert(integrated.cohorts.every(entry => entry.runResult?.metrics?.schemaVersion === 'HistoricalBacktestMetricsV3'), 'integrated cohorts retain canonical single-path metrics');
