...
(function (global) {
    ...
    const TransactionEngine = {
        ...
        determineAction(p) {
            ...
            // FIX: Mindestliquidität sollte auch bei hoher Rente nicht 0 sein.
            // Wir fordern min. 6 Monate des BRUTTO-Floors als absoluten Puffer.
            const minBufferGross = (input.floorBedarf / 12) * 6;
            const krisenMindestLiquiditaet = Math.max(
                (floorBedarfNetto / 12) * input.runwayMinMonths,
                minBufferGross
            );
            ...
            // Puffer-Schutz (gilt jetzt in ALLEN Marktphasen)
            // Wenn Liquidität unter den Sicherheits-Puffer fällt, wird aufgefüllt,
            // egal was die Aktienquote sagt.
            if (aktuelleLiquiditaet <= sicherheitsPuffer) {
