        ...
        container.innerHTML = `
            ...
            ">
                ...
                <span style="font-size: 0.85rem;">
                    ...
                    <a href="depot-tranchen-manager.html" target="_blank" style="color: #667eea; text-decoration: underline;">
                        Tranchen verwalten
                    </a>
                </span>
            </div>
        ...
        ">
            <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 8px;">
                ...
                <div style="display: flex; gap: 6px;">
                    ...
                    <a href="depot-tranchen-manager.html" target="_blank"
                       style="color: white; text-decoration: none; opacity: 0.9; font-size: 0.9rem; border: 1px solid rgba(255,255,255,0.5); padding: 4px 10px; border-radius: 4px; display: inline-block;"
                       onmouseover="this.style.opacity='1'; this.style.background='rgba(255,255,255,0.2)'"
                       onmouseout="this.style.opacity='0.9'; this.style.background='transparent'">
                        🔧 Bearbeiten
                    </a>
                </div>
            </div>
 ...
 */
export function syncTranchenToInputs() {
